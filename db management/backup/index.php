                     ...
                     <div ng-show="isVisible">
                     	...
                     	<table class="table table-striped"> 
                          ...
                          <tr ng-repeat="x in names">  
                               ...
                               <td>{{x.email}}</td>  
                               <td>{{x.course}}</td>  
                               <td><button ng-click="updateData(x.id, x.usn, x.name, x.email, x.course)" class="btn btn-info btn-xs">Update</button></td>
 ...
 app.controller("usercontroller", function($scope, $http){  
      ...
      $scope.insertData = function(){  
           ...
           {  
                $http.post(  
                     "insert.php",  
                     {'u_roll':$scope.u_roll, 'u_name':$scope.u_name, 'u_email':$scope.u_email, 'u_course':$scope.u_course, 'btnName':$scope.btnName, 'id':$scope.id}  
      ...
      $scope.updateData = function(id, usn, name, email, course){  
           $scope.id = id;  
           $scope.u_roll = usn;  
           $scope.u_name = name;
           $scope.u_email = email;  
